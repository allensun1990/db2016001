...
declare @Err int=0,@Status int=-1,@OrderType int,@Name nvarchar(50),@MobilePhone nvarchar(20),@CityCode nvarchar(10),@Address nvarchar(500)

select @Status=Status,@OrderType=OrderType from Orders where OrderID=@OrderID and ClientID=@ClientID 

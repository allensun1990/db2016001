...
select @Public=IsPublic,@DPrice=Price from [Products] where ProductID=@ProductID
...
Update [Products] set [ProductName]=@ProductName,ProductCode=@ProductCode,[GeneralName]=@GeneralName,[UnitID]=@UnitID,IsPublic=@IsPublic,
						...
						[CommonPrice]=@CommonPrice,[Price]=@Price,[Status]=@Status,ProductImage=@ProductImg,
						[DiscountValue]=@DiscountValue,[Weight]=@Weight ,IsAllow=@IsAllow,ProviderID=@ProviderID,

...
--打样-模块名称
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'材料',@CategoryID,                3,     1,      11,  1,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'制版',@CategoryID,                3,     1,      12,  2,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'裁剪',@CategoryID,                3,     1,      13,  3,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'车缝',@CategoryID,                3,     1,      14,  4,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
...
--大货-订单tab
insert into CategoryItems(ItemID, Name,   CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'制版工艺',@CategoryID,   1,    2,     12,   1,   '', @UserID)
insert into CategoryItems(ItemID,Name,    CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'面辅料',  @CategoryID,   1,    2,     11,   2,   '',@UserID)
insert into CategoryItems(ItemID,Name,    CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'加工成本',@CategoryID,   1,    2,     16,   3,   '',@UserID)
insert into CategoryItems(ItemID,Name,    CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'裁片',    @CategoryID,   1,    2,     13,   4,   '',@UserID)
insert into CategoryItems(ItemID,Name,    CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'车缝',    @CategoryID,   1,    2,     14,   5,   '',@UserID)
insert into CategoryItems(ItemID,Name,    CategoryID,  Type,OrderType,Mark,Sort,Remark,CreateUserID)
				values(NEWID(),'发货',    @CategoryID,   1,    2,     15,   6,   '',@UserID)

--大货-订单流程
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'推码/工艺单',@CategoryID,         2,     2,      12,   1,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'面辅料',@CategoryID,              2,     2,      11,   2,   '',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'裁剪',@CategoryID,                2,     2,      13,   3,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'车缝',@CategoryID,                2,     2,      14,   4,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'品控',@CategoryID,                2,     2,      0,    5,'',@UserID)
insert into CategoryItems(ItemID,Name,CategoryID,Type,OrderType,Mark,Sort,Remark,CreateUserID)
values(NEWID(),'发货',@CategoryID,                2,     2,      15,   6,'',@UserID)
